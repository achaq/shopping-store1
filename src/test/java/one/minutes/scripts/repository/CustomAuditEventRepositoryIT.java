package one.minutes.scripts.repository;

import one.minutes.scripts.ShoppingstoreApp;
import one.minutes.scripts.config.Constants;
import one.minutes.scripts.config.audit.AuditEventConverter;
import one.minutes.scripts.domain.PersistentAuditEvent;
...
import static one.minutes.scripts.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
